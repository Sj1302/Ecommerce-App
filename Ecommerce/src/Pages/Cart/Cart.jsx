...
const Cart = () => {
  ...
  const handleMinusClick = (item) => {
    if (item.quantity > 1) {
      dispatch(updQuantity({ ...item, quantity: item.quantity - 1 }));
    } else {
      dispatch(deleteFromCart(item));
    }
  };
  ...
  const totalprice = cartitem
    ...
    .toFixed(2);
  const shippingCost = totalprice > 300 || totalprice == 0 ? 0 : 20;
    ...
    <Layout>
      ...
      >
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg md:w-2/3 mb-[60px]">
            {cartitem &&
                    ...
                    <div className="mt-5 sm:mt-0">
                      ...
                      <div className="flex gap-2 mt-2 p-2 ">
                        <button
                          ...
                          className="border px-2 hover:bg-green-500 hover:text-white rounded-md"
                        >
                          -
                        </button>
