...
const DashboardTab = () => {
  ...
  const { mode, product, editHandle, deleteProducts, setLoading, loading, order, user } =
    context;
          ...
          <Tabs defaultIndex={0} className=" ">
            <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
              ...
              <Tab>
                <button
                  type="button"
                  className="font-medium border-b-2 border-yellow-500 bg-[#605d5d12] text-yellow-500  hover:shadow-yellow-600  rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]    px-5 py-1.5 text-center "
                >
                  <div className="flex gap-2 items-center">
              ...
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className=" flex justify-end">
                  <button
                    type="button"
                    onClick={redirect}
                    className="focus:outline-none text-white bg-yellow-500 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-yellow-600 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2"
                    style={{
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    {order?.map((allorder, orderIndex) =>
                      allorder?.cartitem.map((item, itemIndex) => {
                        ...
                        return (
                          ...
                          >
                            <td className="px-6 py-4 text-black" style={{ color: mode === "dark" ? "white" : "" }}>{slno}.</td>
            ...
            <TabPanel>
              ...
              <div className="relative overflow-x-auto mb-10">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    {user?.map((item, index) => {
                      // Increment slnoforusers if needed
                      const slnoforusers = index + 1;
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {item.name}{" "}
                            {/* Assuming 'name' is a property of each user */}
                          </td>
                          <td
                            className="px-6 py-4 text-black"
                            style={{ color: mode === "dark" ? "white" : "" }}
                          >
                            {item.email}{" "}
                            {/* Assuming 'email' is a property of each user */}
                          </td>
                          <td
                            className="px-6 py-4 text-black"
                            style={{ color: mode === "dark" ? "white" : "" }}
